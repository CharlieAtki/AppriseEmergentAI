...
// Do not bother reviewing this, be happy that it just works :)
/**
...
/**
 * Determine the relative import path to the model barrel from a generated file.
 */
function getModelImportPath(filePath) {
  const rel = relative(join(filePath, ".."), join(GENERATED_DIR, "model"));
