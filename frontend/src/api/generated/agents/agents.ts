...
export const getCreateAgentWorkspacesWorkspaceIdAgentsPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createAgentWorkspacesWorkspaceIdAgentsPost>>, TError,{workspaceId: string;data: CreateAgentRequest}, TContext>, }
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createAgentWorkspacesWorkspaceIdAgentsPost>>, {workspaceId: string;data: CreateAgentRequest}> = (props) => {
          ...
          return  createAgentWorkspacesWorkspaceIdAgentsPost(workspaceId,data,)
        }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListAgentsWorkspacesWorkspaceIdAgentsGetQueryKey(workspaceId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listAgentsWorkspacesWorkspaceIdAgentsGet>>> = ({ signal }) => listAgentsWorkspacesWorkspaceIdAgentsGet(workspaceId, { signal });
...
export function useListAgentsWorkspacesWorkspaceIdAgentsGet<TData = Awaited<ReturnType<typeof listAgentsWorkspacesWorkspaceIdAgentsGet>>, TError = HTTPValidationError>(
 workspaceId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listAgentsWorkspacesWorkspaceIdAgentsGet>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List Agents
...
export const getGetAgentWorkspacesWorkspaceIdAgentsAgentIdGetQueryOptions = <TData = Awaited<ReturnType<typeof getAgentWorkspacesWorkspaceIdAgentsAgentIdGet>>, TError = HTTPValidationError>(workspaceId: string,
    agentId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAgentWorkspacesWorkspaceIdAgentsAgentIdGet>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAgentWorkspacesWorkspaceIdAgentsAgentIdGetQueryKey(workspaceId,agentId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAgentWorkspacesWorkspaceIdAgentsAgentIdGet>>> = ({ signal }) => getAgentWorkspacesWorkspaceIdAgentsAgentIdGet(workspaceId,agentId, { signal });
...
export const getUpdateAgentWorkspacesWorkspaceIdAgentsAgentIdPatchMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateAgentWorkspacesWorkspaceIdAgentsAgentIdPatch>>, TError,{workspaceId: string;agentId: string;data: UpdateAgentRequest}, TContext>, }
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateAgentWorkspacesWorkspaceIdAgentsAgentIdPatch>>, {workspaceId: string;agentId: string;data: UpdateAgentRequest}> = (props) => {
          ...
          return  updateAgentWorkspacesWorkspaceIdAgentsAgentIdPatch(workspaceId,agentId,data,)
        }
